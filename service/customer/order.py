...
class OrderServiceCus(OrderRepo):
    ...
    def insert_order(self, order: OrderReq) -> Row:
        ...
        for order_item in order_items:
            price += order_item['OrderItem'].paid_price
            items_count += 1
    ...
    def delete_cart_item_service(self, username: str) -> None:
        cart_item = CartItemRepo().delete_cart_item_by_uername_repo(username=username)
        return cart_item
